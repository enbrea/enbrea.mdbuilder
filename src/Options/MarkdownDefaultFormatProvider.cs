...
namespace Enbrea.MdBuilder
{
    ...
    /// </summary>
    public class MarkdownDefaultFormatProvider : IMarkdownFormatProvider
    {
        /// <summary>
        /// Tag for emphasis
        /// </summary>
        ...
        /// Text escaping
        /// </summary>
        public IMarkdownEscapeProvider EscapeProvider { get; set; } = new MarkdownDefaultEscapeProvider();
